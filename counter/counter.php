...
<table bgcolor="#FFFFFF" align="center" width="183px">	
	<tr> <th align="center">Thống Kê</th> </tr>
	<tr>
		<td>Đang online: <?php echo online(); ?></td>
	</tr>
	<tr>	
		<td>Truy cập hôm nay: <?php echo today(); ?> </td>
	</tr>	
	<tr>
		<td>	Tổng số truy cập: <?php total(); ?> </td>
	</tr>
	<tr>	
		<td>Truy cập trung bình: <?php avg(); ?> </td>
	</tr>	
</table>